...
class VendorCreditsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.vendor_credits_list = _Endpoint(
            settings={
                'response_type': (PaginatedVendorCreditList,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/vendor-credits',
            ...
            callable=__vendor_credits_list
        )

        def __vendor_credits_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
        ...
        self.vendor_credits_retrieve = _Endpoint(
            settings={
                'response_type': (VendorCredit,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/vendor-credits/{id}',
            ...
            api_client=api_client,
            callable=__vendor_credits_retrieve
        )
