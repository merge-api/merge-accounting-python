...
class TransactionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.transactions_list = _Endpoint(
            settings={
                'response_type': (PaginatedTransactionList,),
                'auth': [
                    'tokenAuth'
                ],
            ...
            callable=__transactions_list
        )

        def __transactions_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
        ...
        self.transactions_retrieve = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__transactions_retrieve
        )
